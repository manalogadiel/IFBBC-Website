...
foreach ($cropSize in $testSizes) {
    ...
    # Now simulate 40x40 badge scaled to 240x240 for high precision inspection
    $size = 240
    $radius = 72 # 12px / 40px * 240px = 72px (rounded-xl)
    ...
    $bmp.Save("c:\Github Repositories and Projects\IFBBC-Website\scratch\badge_s$cropSize.png", [System.Drawing.Imaging.ImageFormat]::Png)
...
$src.Dispose()
Write-Output "Generated previews for 640, 670, 700, 730!"
